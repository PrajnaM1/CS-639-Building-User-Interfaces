...
class Course extends React.Component {
  ...
  getSections() {
    ...
    for (let i =0; i < this.props.data.sections.length; i++){
      ...
      sections.push (
          <Card key={i}>
            <Accordion.Toggle as={Button} variant="link" eventKey={i} style={{height: 63, display: 'flex', alignItems: 'center'}}>
              {"Section " + i}
  ...
  addCourse() {
    var alertText = '[Course: ' + this.props.data.number + '] ' +'added to the cart! Please check the cart to review your courses!';
    alert(alertText);
  ...
  addSection(e, section) {
    var alertText = '[Course: ' + this.props.data.number + ' ' + 'Section: ' + section + '] ' + 'added to the cart! Please check the cart to review your course selection!';
    alert(alertText);
    for(const arr of Object.values(this.props.cdata)){
      var course_presence = false;
      for (const i of arr.data){ //iterating through coursenums
  ...
  addSubsection(e, section, subsection) {
    var alertText = '[Course: ' + this.props.data.number + ', ' + 'Section: ' + section + ', ' + 'Subsection: ' + subsection + '] ' + 'added to the cart! Please check the cart to review your course selection!';
    alert(alertText);
