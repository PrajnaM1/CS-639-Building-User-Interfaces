            ...
            <View key={index}>
                <Card>
                    ...
                    <View style={{ flexDirection: 'row', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'center'}}>
                        ...
                        <TouchableOpacity  style={styles.usrbutton} onPress={() => this.handleDeleteExercise(activity.id)} accessible={true} 
                        accessibilityLabel="Delete button"
                        accessibilityHint="Double tap me to delete the exercise">
    ...
    render() {
        return <>
            <ScrollView style={styles.mainContainer} contentContainerStyle={{ flexGrow: 11, justifyContent: 'center', alignItems: "center" }}>
                ...
                <View style={{ flexDirection: 'row', flexWrap: 'wrap' }}>
                        <TouchableOpacity  style={styles.usrbutton} onPress={() => this.toggleModal(true)} accessible={true} 
                        accessibilityLabel="Add Exercise button"
                        accessibilityHint="Double tap me to add an exercise">
                ...
                <Modal animationType={"slide"} transparent={true}
                    ...
                    <View style={styles.modalView}>
                        ...
                        accessibilityHint="Please tap on the three text fields below to enter exercise details. Set date and time using the buttons after the text fields. Click on save once done. Otherwise, click on the nevermind button at the bottom.">Exercise Details</Text>
                        <View>
                            <Text style={{ textAlignVertical: "center", fontWeight: "700" }} >Exercise Name</Text>
                        </View>
                        <TextInput style={styles.input}
                            ...
                            // value={String(this.state.activityName)}
                            autoCapitalize="none" 
                            accessible={true} accessibilityLabel="Exercise Name"
                        accessibilityHint="Please enter exercise name"/>
                        <View style={styles.spaceSmall}></View>
                        <View>
                            <Text style={{ textAlignVertical: "center", fontWeight: "700" }}>Duration (minutes)</Text>
                        </View>
                        <TextInput style={styles.input}
                            ...
                            // value={String(this.state.activityDuration)}
                            autoCapitalize="none" 
                            accessible={true} accessibilityLabel="Exercise Duration"
                        accessibilityHint="Please enter exercise duration in minutes"/>
                        <View style={styles.spaceSmall}></View>
                        <View>
                            <Text style={{ textAlignVertical: "center", fontWeight: "700" }}>Calories Burnt</Text>
                        </View>
                        <TextInput style={styles.input}
                            ...
                            // value={String(this.state.activityCalBurnt)}
                            autoCapitalize="none"
                            accessible={true} accessibilityLabel="Calories Burnt"
                        accessibilityHint="Please enter Calories Burnt" />
                        <View style={styles.spaceSmall}></View>
                        ...
                        <View style={{ flexDirection: 'row', flexWrap: 'wrap' }}>
                            {/* <TouchableOpacity  style={styles.usrbutton} onPress={() => this.handleSaveExercise()} accessible={true} 
                            accessibilityLabel="Save Exercise Button"
                            accessibilityHint="Double tap me to save the exercise ">
                            <Text style={styles.btntext}>SAVE</Text>
                            </TouchableOpacity> */}
                            <Button color="#942a21" style={styles.buttonInline} title="Save" onPress={() => this.handleSaveExercise()} />
                            <View style={styles.spaceHorizontal} />
                            {/* <TouchableOpacity  style={styles.usrbutton} onPress={() => { this.toggleModal(!this.state.modalVisible) }} accessible={true} 
                            accessibilityLabel="Nevermind Button"
                            accessibilityHint="Double tap me to exit from this modal ">
