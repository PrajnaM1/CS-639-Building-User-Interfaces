...
class Subsection extends React.Component {
	...
	render() {
		return (
			<div>
				<ul>
					<li> {this.props.data.number} <button style={{display : 'inline-block', border:'2px solid light green'}} onClick={this.buttonClick} number={this.props.data.number} sec_num={this.props.num}> Add Subsection </button> </li> 
					<ul>
