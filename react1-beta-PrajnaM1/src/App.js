    ...
    return (
      <>
        ...
        {/*<Tabs defaultActiveKey="search" style={{position: 'fixed', zIndex: 1, width: '100%', backgroundColor: 'white'}}>*/}
          {/*<Tab eventKey="search" title="HOME" style={{paddingTop: '5vh'}}>*/}
            {/* <Sidebar setCourses={(courses) => this.setCourses(courses)} courses={this.state.allCourses} subjects={this.state.subjects}/> */}
            <Row>
              <Col>
                <Image src="https://www.geteducated.com/wp-content/uploads/2019/11/online-tutoring-concept-ebooks-internet-courses-process-vector-staff-vector-id1053519062.jpg"  width='2000px' height='250px'/>
              </Col>
            </Row>
            <Jumbotron style={{backgroundColor:'lightgoldenrodyellow', paddingTop:'20px', paddingBottom:'20px'}}>
              <h1 style={{textAlign:"center"}}>Welcome to Course Enrollment!</h1>
              <h5 style={{textAlign:"center"}}>Please follow the steps to add courses to the cart.</h5>
              <p style={{textAlign:"center"}}>Click on 'Finish' after STEP 3 to submit final course enrollment.</p>
            </Jumbotron>
           
            {/*<div style={{marginLeft: '20vw'}}>*/}
              <CreateSteps setCourses={(courses) => this.setCourses(courses)} courses={this.state.allCourses} subjects={this.state.subjects} data={this.state.filteredCourses} allData={this.state.allCourses} cartMode={false} AddCourseToCart0={this.setCartCourse} AddSectionToCart0={this.setCartSection} AddSubsectionToCart1={this.setCartSubsection} dataCart={this.state.cart} RemoveCourseFromCart0={(e,msg) => this.removeCartCourse(e,msg)} RemoveSectionFromCart0={this.removeCartSection} RemoveSubsectionFromCart1={this.removeCartSubsection}/>
