...
class Subsection extends React.Component {
	...
	buttonClick(event){
        this.props.RemoveSubsectionFromCart4(event, this.props.data);
    }
	...
	render() {
		return (
			<div>
				<ul>
					<li> {this.props.data.number} <button style={{display : 'inline-block', border:'3px solid light red'}} onClick={this.buttonClick} number={this.props.data.number} sec_num={this.props.num}> Remove Subsection </button> </li> 
					<ul>
