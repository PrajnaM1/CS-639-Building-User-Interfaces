...
class Subsection extends React.Component {
	...
	render() {
		return (
			<div>
				<ul>
					<li> {this.props.data.number} <button style={{display : 'inline-block'}} onClick={this.buttonClick} number={this.props.data.number} sec_num={this.props.num}> Remove Subsection </button> </li> 
					<ul>
